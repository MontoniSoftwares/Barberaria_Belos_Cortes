...
<head>
    ...
    <meta name="description" content="Barberaria Belos Cortes em Rio das Ostras. #barbearia #riodasostras #salao #belocorte">
...
<body>
        ...
        <div class="container">
            <div class="cover-container h-100 p-2 mx-auto flex-column centralizar">
                <main role="main" class="inner cover wow fadeInDown">
                    ...
                    <h1 class="cover-heading  font2">Bem Vindo à Barberaria Belos Cortes!</h1>
                    ...
                    <p class="lead ">
                        <a href="# " class="btn btn-md btn-success animated fadeInUp delay-1s ">Learn more</a>
                    </p>
                </main>
        ...
        <div class="container mt-5 wow fadeIn">
            <div class="row ">
                ...
                <div class="col-md-5 ">
                    ...
                    <img src="img/9.jpg" class="rounded shadow-lg img-fluid" alt="21w ">
    ...
    <section class="section3">
        ...
        <div class="container">
            ...
            <h1 class="text-center text-warning font3"> ~ Nossos Profissionais </h1>
            ...
            <div class="row row-cols-1 row-cols-md-3 justify-content-center mt-5" style="margin-top:10%; ">
                <div class="col mt-2">
                    <div class="card shadow rounded wow fadeIn">
                        <img class="card-img-top" src="img/barber1.jpg " alt="Imagem de capa do card " width="200 " height="200 ">
                        <div class="card-body">
                            <h5 class="card-title"><strong class="text-danger"> 01.</strong>Breno Silva</h5>
            ...
            <div class="row">
                <div class="col-md-4 dark">
                    <div class="ml-5 row row-cols-4">
                        <span class="col">
                            <a href="https://www.facebook.com/robertomontoni/ " target="_blank ">
                                <img src="https://img.icons8.com/doodle/48/000000/facebook-circled.png " alt="Facebook Barber ">
                            </a>

                        </span>
                        <span class="col" style="margin-left:20px; ">
                            <a href="https://www.instagram.com/robertomontoni " target="_blank ">
                                <img src="https://img.icons8.com/color/48/000000/instagram-new.png " alt="Instagram Barber " title="Instagran Barber ">
                            </a>

                        </span>
                        <span class="col" style="margin-left:20px; ">
                            <a href="https://api.whatsapp.com/send?phone=5522988612564&text=Ol%C3%A1%2C%20Quero%20saber%20mais%20sobre%20a%20Imantel. " target="_blank ">
                                <img src="https://img.icons8.com/color/48/000000/whatsapp.png " alt="WhatsApp Barber " title="WhatsApp Barber ">
                            </a>

                        </span>
                    </div>
                    <p class="col font1"><br> Barberaria Belos Cortes, ©Copyright 2023.
                        <i class="text-secondary"> Desenvolvido por Roberto Montoni</i>
                    </p>
                </div>
                <div class="col-md-7">
